...
raw_nurse_homes = './data/raw/nurse-homes-covid-19.csv'
...
if __name__ == "__main__":
    ...
    scraper.scrape_nursing_homes(facility_sheet, raw_nurse_homes)
    scraper.scrape_zip_codes(main_sheet, raw_zip)

    cleaner.clean_nursing_homes(raw_nurse_homes)
